...
const Map = ({ className, children, mapData }) => {
  ...
  const testGEOJSNO = [
    [4.945809020000035, 52.34691296],
    [4.945346378076248, 52.347202619618365],
    [4.9460071624781, 52.34759645951282],
    [4.9464698, 52.3473068],
    [4.945809020000035, 52.34691296],
  ];
  useEffect(() => {
  ...
  useEffect(() => {
    if (map.current.loaded()) {
      if (mapType === "rect") {
        ...
        console.log(map.current.getSource("field"));
      } else if (mapType === "gps") {
        console.log("maptype is gps");
        if (map.current.getSource("field")) {
          console.log("field is delete");
        ...
        for (let item in gpsExtractions) {
